...
@Component({
  selector: 'app-customer-edit-title',
  templateUrl: './customer-edit-title.component.html',
  styleUrls: ['./customer-edit-title.component.css']
})
export class CustomerEditTitleComponent extends DataHandlerComponent implements OnInit {
